    ...
    <>
      ...
      <div className={styles.preCta}>
        <div className={styles.preCtaInner}>
          <h2 className={styles.preCtaTitle}>Ready to start?</h2>
          <p className={styles.preCtaSub}>Book a free 30-minute discovery call. No pressure, no pitch — just a conversation about your goals.</p>
